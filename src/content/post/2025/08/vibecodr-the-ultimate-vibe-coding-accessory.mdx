...
You should now have a fully assembled button, looking like this. ![Assembled Button](/images/post/2025/08/08/vibecodr-internals.jpg)

<Notice type="tip">
  You can happily run this on any board that supports CircuitPython or even
  MicroPython. I just made use of the Plasma because I had a few handy and it
  has all the connections I needed.
</Notice>
...
![Assembled Button](/images/post/2025/08/08/vibecodr-animated.gif)
